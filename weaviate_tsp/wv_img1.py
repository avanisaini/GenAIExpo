...
text_path = '/home/ssm-user/weaviate/tsp/data/text/'  #date this with the actual directory path containing your files
img_path = '/home/ssm-user/weaviate/tsp/data/image/' #Sample images
